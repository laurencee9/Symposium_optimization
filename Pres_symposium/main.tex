...
\begin{table}[h!]
  ...
  Déterministe & Stochastique & Stochastique\\
    - & $\beta_0,\gamma,\alpha$ & \\
  \includegraphics[width=3cm]{figures/tabou2v2.pdf}& \includegraphics[width=2.7cm]{figures/firefly2_v2.pdf}\\
  \hline
  \end{tabular}
\end{table}
...
\begin{frame}{Problème du vendeur - Distribution des distances}
